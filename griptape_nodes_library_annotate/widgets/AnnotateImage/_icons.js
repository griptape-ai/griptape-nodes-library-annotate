...
export const ICON_PATHS = {
  ...
  "order-front":    `<path d="M5 3h14"/><path d="m18 13-6-6-6 6"/><path d="M12 7v14"/>`,
  "order-forward":  `<path d="m5 12 7-7 7 7"/><path d="M12 19V5"/>`,
  "order-backward": `<path d="M12 5v14"/><path d="m19 12-7 7-7-7"/>`,
  "order-back":     `<path d="M12 17V3"/><path d="m6 11 6 6 6-6"/><path d="M19 21H5"/>`,
  ...
  "lock-open":   `<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 1 1 9.9-1"/>`,
  ...
  // ── Rect shape variant icons ──────────────────────────────────────────────────
  "rect-plain":   `<rect x="3" y="7" width="18" height="10"/>`,
  "rect-rounded": `<rect x="3" y="7" width="18" height="10" rx="4"/>`,
  "rect-pill":    `<rect x="2" y="9" width="20" height="6" rx="3"/>`,

  // ── Ellipse shape variant icons ───────────────────────────────────────────────
  "ellipse-plain": `<ellipse cx="12" cy="12" rx="10" ry="6"/>`,

  // ── Stamp icons ───────────────────────────────────────────────────────────────
  "stamps":              `<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"/><path d="m9 12 2 2 4-4"/>`,
  "stamp-checkmark":     `<polyline points="4,13 9,18 20,6"/>`,
  "stamp-cross":         `<line x1="5" y1="5" x2="19" y2="19"/><line x1="19" y1="5" x2="5" y2="19"/>`,
  "stamp-no":            `<circle cx="12" cy="12" r="9"/><line x1="6" y1="18" x2="18" y2="6"/>`,
  "stamp-warning":       `<path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><circle cx="12" cy="17" r="0.5" fill="currentColor"/>`,
  "stamp-question":      `<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><circle cx="12" cy="17" r="0.5" fill="currentColor"/>`,
  "stamp-exclamation":   `<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><circle cx="12" cy="16" r="0.5" fill="currentColor"/>`,
  "stamp-thumbs-up":     `<path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88z"/>`,
  "stamp-thumbs-down":   `<path d="M17 14V2"/><path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88z"/>`,
  "stamp-pin":           `<path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/>`,
};
