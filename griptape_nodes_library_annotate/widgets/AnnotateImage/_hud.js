// Object actions panel for the AnnotateImage widget.
// Renders into the objectActionsEl container (right side of header bar) when annotations are selected.
// createHud(el, deps) → { update, dismissLayerPopup }
...
export function createHud(el, {
  ...
  // Rebuilds the object actions panel. Always visible when any annotations exist
  // (for "delete all"); selection-specific actions additionally shown in select mode.
  function update() {
